...
import uo.sdi.business.impl.actions.task.ListTasksNotFinished;
 ...
 * (referidos al manejo y administración de las tareas) a los distintos usuarios
 * del sistema.
 * 
...
public class TaskServiceImpl implements TaskService {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uo.sdi.business.TaskService#addTask(java.lang.String,
	 * uo.sdi.dto.CategoryDTO, uo.sdi.dto.TaskDTO)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uo.sdi.business.TaskService#updateTask(uo.sdi.dto.TaskDTO,
	 * uo.sdi.dto.TaskDTO)
	 */
	@Override
	public void updateTask(TaskDTO taskDTO) throws BusinessException {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uo.sdi.business.TaskService#listTasksInbox(java.lang.String,
	 * boolean)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see uo.sdi.business.TaskService#listTasksByCategory(java.lang.String,
	 * java.lang.String)
	 */
	@SuppressWarnings("unchecked")
	@Override
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<TaskDTO> listTasksCreatedAndNotFinished(String login)
			throws BusinessException {
		return (List<TaskDTO>) executor
				.execute(new ListTasksNotFinished(login));
	}

	/*
	 * (non-Javadoc)
	 * 
	 * @see uo.sdi.business.TaskService#findTask(java.lang.String,
	 * java.util.Date)
	 */
	@Override
