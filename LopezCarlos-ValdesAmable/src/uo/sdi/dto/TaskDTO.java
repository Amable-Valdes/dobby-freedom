...
public class TaskDTO {
	...
	public TaskDTO setComments(String comments) {
	...
	public TaskDTO setPlanned(Date planned) {
	...
	public TaskDTO setFinished(Date finished) {
	...
	public TaskDTO setCategoryId(Long category_id) {
	...
	public TaskDTO setUserId(Long user_id) {
		this.userId = user_id;
		return this;
	}
